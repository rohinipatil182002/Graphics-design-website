...
@Component({
  selector: 'app-sport-event-management',
  templateUrl: './sport-event-management.component.html',
  styleUrls: ['./sport-event-management.component.css']
})
export class SportEventManagementComponent {
